...
RSpec.feature 'User show page', type: :system do
  before do
    @user = User.create(name: 'John Doe', photo: 'john_doe.jpg', bio: 'Bio for John Doe', posts_counter: 0)
    5.times do |i|
  ...
  scenario "I can see the user's profile picture" do
    ...
    expect(page).to have_css(".user-photos")
  end
