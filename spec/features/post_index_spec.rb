...
RSpec.feature 'User Posts index page', type: :feature do
  ...
  scenario "When I click on a post, it redirects me to that post's show page" do
    visit user_posts_path(@user)
    click_link('Post 1')
    expect(page.current_path).to eq(user_post_path(@user, @post1))
  end
end
...
RSpec.feature 'User Posts index page', type: :feature do
  before do
    ...
    @comment3 = Comment.create(author: @user, post: @post1, text: 'comment 3')
    @comment4 = Comment.create(author: @user, post: @post1, text: 'comment 4')
    @comment5 = Comment.create(author: @user, post: @post1, text: 'comment 5')
  end
